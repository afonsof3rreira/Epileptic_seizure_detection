...
// WIFI CONFIGURATION
const char * networkName = "AndroidAP.D"; // MEO-59E8C0
const char * networkPswd = "otla9444"; // 7b04aebe7b
...
void loop()
{
  ...
  if (prev_t - post_t >= Ts) { //if (prev_t - post_t >= Ts && myICM.dataReady()) {
    ...
    */
    ...
    PPGval = analogRead(PPGpin) / 4096.0;
    ...
    if (sendd == 1){
      ...
      if (Firebase.getString(firebaseData, path_seizure)) { 
          Firebase.deleteNode(firebaseData, path_seizure);
          seizure = 1;  
          post_buzz = prev_t;   
      }
    }
